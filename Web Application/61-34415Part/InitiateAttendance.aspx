<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InitiateAttendance.aspx.cs" Inherits="HR.InitiateAttendance" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:Button ID="btnInitiate" runat="server" Text="Initiate Attendance Today" CssClass="btn-action" OnClick="btnInitiate_Click" />
