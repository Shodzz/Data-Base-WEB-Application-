<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyMedicalLeave.aspx.cs" Inherits="_61_34415Part.ApplyMedical" %>
...
<form id="form1" runat="server">
    <div class="leave-container">
        ...
        <div class="form-group">
            <label>Insurance Status (1 or 0)</label>
            <asp:TextBox ID="txtInsuranceStatus" runat="server" />
        </div>
        ...
        <asp:Button ID="btnSubmit" runat="server" Text="Submit Medical Leave"
