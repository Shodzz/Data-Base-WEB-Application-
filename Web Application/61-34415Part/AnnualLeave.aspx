<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnnualLeave.aspx.cs" Inherits="YourNamespace.AnnualLeave" %>
...
<form id="form1" runat="server">
    <div class="leave-container">
        ...
        <asp:Button ID="btnSubmitLeave" runat="server" Text="Submit Annual Leave"
            CssClass="submit-btn" OnClick="btnSubmitLeave_Click" />
