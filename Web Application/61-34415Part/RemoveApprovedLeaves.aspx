<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemoveApprovedLeaves.aspx.cs" Inherits="HR.RemoveApprovedLeaves" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:Button ID="btnRemoveApprovedLeaves" runat="server" 
                        ...
                        CssClass="btn-action" OnClick="btnRemoveApprovedLeaves_Click" />
