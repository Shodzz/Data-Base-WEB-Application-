<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveCompensationLeave.aspx.cs" Inherits="HR.ApproveCompensationLeave" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Approve Compensation Leaves</title>
    <style>
        .btn-action {
...
<body>
    <form id="form1" runat="server">
        <div class="dashboard-box">
            <h2>Approve Compensation Leaves</h2>
